...
describe('findOdd tests', () => {
  it('should return 3', () => {
    expect(findOdd([3])).toEqual(3);
    expect(findOdd([1, 1, 3])).toEqual(3);
    expect(findOdd([1, 1, 2, 2, 3])).toEqual(3);
    expect(findOdd([1, 1, 1, 1, 2, 2, 3, 3, 3])).toEqual(3);
    expect(findOdd([1, 1, 2, 2, 3, 4, 4, 4, 4])).toEqual(3);
  });
  ...
  it('should return the expected number', () => {
    ...
    expect(findOdd([5,4,3,2,1,5,4,3,2,10,10])).toEqual(10);
  });
});
